...
function delete_expense() {
    ...
    $.ajax({
        url: '/recordCategory/delete-doc?name=' + table.rows[expenseNO].children[1].innerHTML + '&incomeOrExpense=支出',
        type: 'DELETE',
...
function delete_income() {
    ...
    $.ajax({
        url: '/recordCategory/delete-doc?name=' + table.rows[incomeNO].children[1].innerHTML + '&incomeOrExpense=收入',
        type: 'DELETE',
        success: function (result) {
            console.log(result);
        }
