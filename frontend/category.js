...
function delete_expense(){
    ...
    $.ajax({
        url: 'http://172.20.10.3:9000/recordCategory/delete-doc?userID=user001&name='+table.rows[expenseNO].children[1].innerHTML+'&incomeOrExpense=支出',
        type: 'DELETE',
...
function delete_income(){
    ...
    $.ajax({
        url: 'http://172.20.10.3:9000/recordCategory/delete-doc?userID=user001&name='+ table.rows[incomeNO].children[1].innerHTML +'&incomeOrExpense=收入',
        type: 'DELETE',
        success: function(result) {
            console.log(result);
        }
...
function complete_expense(obj){
    ...
    if(editExpense == 0){   //f5後編輯
        ...
        fetch('http://172.20.10.3:9000/recordCategory/insert-doc',
            {
                method: "POST",
                headers: {
        ...
        fetch('http://172.20.10.3:9000/recordCategory/update-doc',
            {
                method: "PUT",
                headers: {
                    'Content-Type': 'application/json'
